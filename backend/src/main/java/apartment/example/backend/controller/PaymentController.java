        ...
        try {
            ...
            for (Map.Entry<String, Map<String, List<Payment>>> tenantEntry : groupedPayments.entrySet()) {
                ...
                for (Map.Entry<String, List<Payment>> monthEntry : tenantEntry.getValue().entrySet()) {
                    ...
                    summary.put("tenantName", monthPayments.get(0).getLease().getTenant().getFirstName() + " " + 
                                                monthPayments.get(0).getLease().getTenant().getLastName());
                    summary.put("unitNumber", monthPayments.get(0).getLease().getUnit().getRoomNumber());
                    ...
                    summary.put("breakdown", breakdown); // Add breakdown for frontend
