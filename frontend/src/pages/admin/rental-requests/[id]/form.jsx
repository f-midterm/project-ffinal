...
import { getRentalRequestById, approveRentalRequest, rejectRentalRequest } from '../../../../api/services/rentalRequests.service'
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Rental Request Details</h1>
                        <p className="text-gray-600 mt-1">Request ID: #{request.id}</p>
                    </div>
                    <span className={`px-4 py-2 rounded-full text-sm font-semibold ${getStatusBadgeColor(request.status)}`}>
                        {request.status}
                    </span>
                </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h2 className="text-lg font-semibold mb-4 text-gray-900">REQUEST INFORMATION</h2>
                <div className="grid grid-cols-2 gap-4">
                    ...
                    {request.approvedDate && (
                        <div>
                            ...
                            <p className="text-base text-gray-900">{formatDate(request.approvedDate)}</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            {/* Unit Details */}
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h2 className="text-lg font-semibold mb-4 text-gray-900">UNIT DETAILS</h2>
                {request.unit ? (
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="text-sm font-medium text-gray-600">Unit Number</p>
                            <p className="text-base text-gray-900">Si {request.unit.roomNumber}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">฿{request.unit.rentAmount}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-base text-gray-900">{request.unit.sizeSqm} sqm</p>
                        </div>
                        <div>
            ...
            {/* Tenant Information */}
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h2 className="text-lg font-semibold mb-4 text-gray-900">TENANT INFORMATION</h2>
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <p className="text-sm font-medium text-gray-600">Name</p>
                        <p className="text-base text-gray-900">{request.firstName} {request.lastName}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-base text-gray-900">{request.occupation || 'N/A'}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-600">Emergency Contact</p>
                        <p className="text-base text-gray-900">{request.emergencyContact || 'N/A'}</p>
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-600">Emergency Phone</p>
                        <p className="text-base text-gray-900">{request.emergencyPhone || 'N/A'}</p>
                    </div>
                </div>
            </div>
            ...
            {/* Lease Details */}
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <h2 className="text-lg font-semibold mb-4 text-gray-900">LEASE DETAILS</h2>
                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <p className="text-sm font-medium text-gray-600">Duration</p>
                        <p className="text-base text-gray-900">
                            {request.leaseDurationMonths} month{request.leaseDurationMonths > 1 ? 's' : ''}
                        </p>
                    </div>
                    <div>
                ...
                {request.notes && (
                    <div>
                        ...
                        <p className="text-base text-gray-900 bg-gray-50 p-3 rounded">{request.notes}</p>
                    </div>
                )}
            </div>
            ...
            {request.status === 'REJECTED' && request.rejectionReason && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                    <h2 className="text-lg font-semibold mb-2 text-red-900">REJECTION REASON</h2>
            ...
            {isActionable && (
                <div className="bg-white rounded-lg shadow p-6 mb-6">
                    <h2 className="text-lg font-semibold mb-4 text-gray-900">ADMIN ACTIONS</h2>
                    
                    {/* Lease Start and End Date */}
                    <div className="mb-6">
                        <h3 className="text-md font-medium text-gray-700 mb-3">Lease Period (Required for Approval)</h3>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">When tenant can move in</p>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                                />
                                <p className="text-xs text-gray-500 mt-1">Lease expiration date</p>
                            </div>
                        </div>
                    </div>
