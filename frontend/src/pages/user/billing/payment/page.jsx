    ...
    <div className='mx-auto p-6'>
      ...
      <div className='bg-white rounded-xl shadow-md p-6 mb-6'>
        <div className='flex justify-between items-start mb-4'>
          <div>
            <h1 className='text-2xl font-bold text-gray-800 mb-2'>Invoice Payment</h1>
      ...
      {(invoice.status === 'PENDING' || invoice.status === 'REJECTED') && (
        <div id="qr-code-section" className='bg-white rounded-xl shadow-md p-6 mb-6'>
          <h2 className='text-xl font-bold text-gray-800 mb-4 text-center'>Scan to Pay with PromptPay</h2>
          <div className='flex flex-col items-center gap-4'>
            <div className='bg-white p-6 rounded-lg border-4 border-blue-500'>
              <QRCodeCanvas
                value={generatePayload(PROMPTPAY_ID, { amount: parseFloat(totalWithLateFee) })}
                size={256}
                level='H'
                includeMargin={true}
              />
            ...
            <div className='text-center'>
              <p className='text-gray-600 mb-2'>Scan QR Code with your banking app</p>
              <p className={`text-2xl font-bold ${daysLate > 0 ? 'text-red-600' : 'text-blue-600'}`}>
                ฿{formatCurrency(totalWithLateFee)}
              </p>
              {daysLate > 0 && (
                <p className='text-sm text-red-600 mt-1'>
                  Includes ฿{formatCurrency(lateFee)} late fee ({daysLate} day{daysLate > 1 ? 's' : ''})
                </p>
              )}
      ...
      {invoice.status === 'WAITING_VERIFICATION' && (
        <div className='bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg mb-6'>
          <div className='flex items-start gap-4'>
            ...
            <div>
              <h3 className='text-lg font-semibold text-blue-900 mb-2'>Payment Under Verification</h3>
              <p className='text-blue-800 mb-2'>
                Your payment slip has been submitted successfully and is currently being verified by our admin team.
              </p>
              <p className='text-blue-700 text-sm'>
                You will be notified once the payment is confirmed. This usually takes 1-2 business days.
              </p>
              {invoice.slipUrl && (
                <div className='mt-4'>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div>
              ...
              <p className='text-green-800'>
                Your payment has been verified and confirmed. Thank you for your payment!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='mt-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-lg'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-red-700 text-sm'>Please pay as soon as possible to avoid late fees.</p>
            </div>
          </div>
        </div>
      )}
