...
function BookingPage() {
  ...
  /**
   * Show approved booking view (read-only)
   * TODO: Create ApprovedBookingView component
   */
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-blue-800">
              You can now access your dashboard to view your lease details and manage your profile.
            </p>
          </div>
