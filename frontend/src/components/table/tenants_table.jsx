            ...
            <table className="min-w-full divide-y divide-gray-200">
                <thead className='bg-gray-50'>
                    <tr>
                        ...
                        <th className='px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider'>Lease Peroid</th>
                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                    <tr className='hover:bg-gray-50'>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">johndoe@comapny.com</td>
                        <td className="px-6 py-4 whitespace-nowrap">0999999999</td>
                        <td className="px-6 py-4 whitespace-nowrap">Si101</td>
                        <td className="px-6 py-4 whitespace-nowrap">01/07/2025 - 30/06/2026</td>
